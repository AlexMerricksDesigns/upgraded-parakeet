...
import { getWorkCategory } from "../categories";
import { categoryPath } from "@/lib/work-paths";

const category = getWorkCategory("nursery");

const config = {
  categoryTitle: category.title,
  categoryRoute: categoryPath("nursery"),
  page: {
  ...
  relatedOnSite: [
    { href: "/work/archive", label: "Work archive", summary: "Older and in-progress entries" },
  ...
  projectSections: [
    {
      id: "coming",
      title: "Coming soon",
      intro: "Nursery project pages will be added here as they are migrated from cold storage.",
      groups: [
        {
          id: "placeholder",
          title: "Placeholder",
          items: [
            {
              ...
              year: "Archive",
              summary: "Interim index of older work while this thread is built out.",
              href: "/work/archive",
              external: false,
              image: null,
              platform: "Archive",
...
export default function NurseryCategoryPage() {
