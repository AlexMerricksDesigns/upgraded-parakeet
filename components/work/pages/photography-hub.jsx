...
const PAGE_DESCRIPTION =
  "Lens-based observation — captured works, on-chain editions as xanderhizome, and field notes from nearly two decades of seeing, pausing, and archiving.";
...
const relatedOnSite = [
  ...
  },
  {
    href: `${categoryPath("photography")}#published`,
    label: "Published (NFTs)",
    summary: "On-chain editions, essays, and digital provenance",
  },
  {
  ...
  },
  {
    ...
    summary: "Living systems and tactile prototypes",
  },
  {
...
const shopRail = {
  ...
  products: [
    ...
    },
    {
      ...
      href: productPath("photography", "digital-editions"),
